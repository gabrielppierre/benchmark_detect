...
- Foram encontrados 300 arquivos de imagem e 1495 anotações em um pacote directory.
...
- evidências curtas:
- arquivo de anotação `annotations/instances_default.json`
...
- limitações atuais:
- todas as imagens estão sob a mesma pasta de origem observável: images/default
